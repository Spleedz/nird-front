...
const MedievalRitual = ({ onComplete }) => {
          ...
          <div className="treasure-anim">
            ...
            <button
              ...
              style={{
                ...
                background: 'linear-gradient(135deg, #d4af37, #aa8c2a)',
              ...
              onMouseEnter={(e) => {
                ...
                e.target.style.boxShadow = '0 0 30px rgba(212, 175, 55, 1)';
              }}
              onMouseLeave={(e) => {
